        ...
        <div class="card login-card">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="email" id="email" class="form-control <?= isset($_GET['email_validation']) ? 'is-invalid' : '' ?>" placeholder="Digite seu e-mail" value="<?= isset($_POST['email']) ? $_POST['email'] : '' ?>" autofocus>
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="password" id="password" class="form-control <?= isset($_GET['password_validation']) ? 'is-invalid' : '' ?>" placeholder="Digite sua senha">
                    <div class="invalid-feedback">
